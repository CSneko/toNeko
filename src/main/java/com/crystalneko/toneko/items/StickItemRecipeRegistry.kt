...
object StickItemRecipeRegistry {

    fun registerRecipe(){
        // 创建一个具有特定形状的合成配方
        val recipe = ShapedRecipe(NamespacedKey(ToNeko.pluginInstance, "toneko.item.stickLevel2"), StickItemWrapper.wrapStickItemLevel2())
        // 设置合成配方的形状
        /*
         牛奶 | 一级棍 | 牛奶
         牛奶 | 末地烛 | 牛奶
        ...
        val itemChoice = RecipeChoice.ExactChoice(StickItemWrapper.wrapStickItem())
        // 设置形状中每个字符对应的原材料
