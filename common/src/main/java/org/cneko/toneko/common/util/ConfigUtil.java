...
public class ConfigUtil {
    ...
    public static final ConfigBuilder CONFIG_BUILDER = ConfigBuilder.create(Path.of(CONFIG_FILE))
            ...
            .addString("ai.prompt","你是一只可爱的猫娘，你的名字是%neko_name%，你的身高是%neko_height%，你的属性有%neko_moe_tags%。在回复时请不要太长且不要有太多动作。我是你的主人，我的名字是%player_name%，我%player_is_neko%一只猫娘","https://s.cneko.org/toNekoAI",
