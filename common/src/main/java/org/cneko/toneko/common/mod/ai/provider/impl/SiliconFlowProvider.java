...
/**
 * SiliconFlow provider — Chinese AI model aggregator, OpenAI-compatible.
 */
public class SiliconFlowProvider implements AIServiceProvider {

    @Override
    public String getProviderId() { return "siliconflow"; }

    @Override
    public String getDisplayName() { return "SiliconFlow"; }
    ...
    @Override
    public String getDefaultHost() { return "api.siliconflow.cn"; }
    ...
    @Override
    public String getDefaultModel() { return "Qwen/Qwen2.5-7B-Instruct"; }
