...
public class Permissions {
    ...
    public static String COMMAND_TONEKOADMIN_SET_LEVEL = "command.tonekoadmin.setLevel";
    ...
    public static String COMMAND_TONEKOADMIN_CONFIG = "command.tonekoadmin.config";
    public static String COMMAND_TONEKOADMIN_NEKO = "command.tonekoadmin.neko";
    ...
    public static String COMMAND_TONEKO_GUI = "command.toneko.gui";
    ...
    public static String COMMAND_NEKO_CHAT = "command.neko.chat";
