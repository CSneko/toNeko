...
public class ToNekoClient {
    public static void init(){
        ...
        FabricLoader.getInstance().getModContainer(MODID).ifPresent(container-> ResourceManagerHelper.registerBuiltinResourcePack(Identifier.fromNamespaceAndPath(MODID, "moe"),container, Component.translatable("resourcePack.toneko.moe"), ResourcePackActivationType.NORMAL));
