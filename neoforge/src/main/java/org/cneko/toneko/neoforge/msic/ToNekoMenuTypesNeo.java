...
public class ToNekoMenuTypesNeo {
    ...
    public static void init(IEventBus bus){
        ...
        LEGWEAR_WORKBENCH = new MenuType<>(LegwearWorkbenchBlock.LegwearWorkbenchMenu::new, FeatureFlags.VANILLA_SET);
    ...
    public static void onRegisterMenus(RegisterEvent event) {
        event.register(Registries.MENU, helper -> {
            ...
            helper.register(toNekoLoc("legwear_workbench"), LEGWEAR_WORKBENCH);
        });
    }
